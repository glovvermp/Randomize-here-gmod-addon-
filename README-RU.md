...
Первый аддон, написанный мной. GLua изучался в процессе разработки. Планируются обновления и поддержка.
...
Распакуйте архив в директорию (только для последней версии): 
